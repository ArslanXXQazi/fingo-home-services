...
class AppColors
{
  ...
  static final Color orangeColor= Color(0XFFFE8E16);
  static final Color greyColor= Color(0XFF4E4E4E);
  static final Color greyText= Color(0XFF878787);
  static final Color brownColor= Color(0XFFFDAF19);
